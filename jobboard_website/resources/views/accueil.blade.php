...
@section('content')
    <div class="container text-justify">
        ...
        <p> Les étudiants suivent une formation, sur deux années après le baccalauréat, qui les formes dans plusieurs domaine : </p><br>
        ...
        <p> Chaque année nous organisons des <b>Job-Dating</b> afin de faciliter le dialogue entre les étudiants et les entreprise.<br>
